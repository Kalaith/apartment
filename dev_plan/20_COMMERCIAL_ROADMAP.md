...
The measured state (sim harness, 60 seeds × 3 strategies): Greedy ends at ~20× starting funds with 0 upgrades needed. The playtest corroborates: no reason to reject tenants, staff impact invisible, no reason to sell. The 2026-07-03 tuning pass gave neglect real teeth (Slumlord finishes last); item 3.1 below then made neglect genuinely *loseable*.
